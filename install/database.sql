...
CREATE TABLE `avps` (
  `arg` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `value_s` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `value_i` int NOT NULL DEFAULT '0',
  `value_u` int unsigned NOT NULL DEFAULT '0',
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`arg`),
  KEY `idx_value_i` (`value_i`),
  KEY `idx_value_u` (`value_u`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='AVP (Attribute-Value Pairs) storage';
...
CREATE TABLE `bans` (
  ...
  `type` enum('ip','email','username','range') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ip',
  `expires_at` datetime DEFAULT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `metadata` json DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_first_last` (`first`,`last`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Ban list and restrictions';
...
CREATE TABLE `invites` (
  ...
  `time_invited` datetime NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `simpaty` (
  ...
  `respect_time` datetime NULL default CURRENT_TIMESTAMP,
  `description` text NOT NULL,
  PRIMARY KEY  (`id`),
...
INSERT INTO `countries` (`id`, `name`, `flagpic`) VALUES
  (87, '������� � �������', 'antiguabarbuda.gif'),
  (33, '�����', 'belize.gif'),
  (59, '������� ����', 'burkinafaso.gif'),
  (10, '�����', 'denmark.gif'),
  (91, '�������', 'senegal.gif'),
  (76, '�������� � ������', 'trinidadandtobago.gif'),
  (20, '���������', 'australia.gif'),
  (36, '�������', 'austria.gif'),
  (27, '�������', 'albania.gif'),
  (34, '�����', 'algeria.gif'),
...
<td class="block"><a href="staffmess.php">Сообщение штабу</a></td>
</tr><tr>
