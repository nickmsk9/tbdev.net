...
<td width=20 class=colhead>���</td>
<td class=colhead>�� ����</td>
<td class=colhead>�� ���</td>
<td class=colhead>�������</td>
<td class=colhead align=center width="10%">����</td>
<?
if ($admin)
...
<?
        ...
        while ($arr = mysqli_fetch_assoc($res)) {
                ...
                if (substr($arr["type"],0,7) == 'torrent') {
                        $from_what = '<a href="details.php?id=' . substr($arr["type"],7,strlen($arr["type"])) . '&hit=1">' . "�������" . '</a>';
                }
                elseif (substr($arr["type"],0,7) == 'comment') {
                        ...
                        $from_what = '<a href="' . $filename . '?id=' . $id . '&page=' . $page . '&viewcomm=' . $comment_id . '#comm' . $comment_id . '">' . "�����������" . '</a>';
                }
                elseif (substr($arr["type"],0,7) == 'request')
                        $from_what = '<a href="requests.php?id=' . substr($arr["type"],7,strlen($arr["type"])) . '">' . "������" . '</a>';
                elseif (substr($arr["type"],0,5) == 'offer')
                        $from_what = '<a href="offers.php?id=' . substr($arr["type"],5,strlen($arr["type"])) . '">' . "�����������" . '</a>';
                /*$tracker_template->assign_block_vars('simpaty_section.switch_count.simpaty_row', array(
                        ...
                        'TYPE' => $arr["good"]==1?'<img src="pic/thum_good.gif" alt="' . "�������" . '" title="' . "�������" . '">':'<img src="pic/thum_bad.gif" alt="' . "�����������" . '" title="' . "�����������" . '">',
