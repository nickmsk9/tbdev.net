...
define('COOKIE_SALT', 'kQ3!9xP$vT#rA2bW&zY1mJ@qF%hN7^gS*'); // Должен быть длинным случайным строкой

define('COOKIE_UID', 'tb_uid');      // Название cookie для ID пользователя
define('COOKIE_PASSHASH', 'tb_pass'); // Название cookie для хэша пароля
