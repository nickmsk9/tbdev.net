    ...
    foreach ($rows as $row) {
        ...
        if (isset($row["username"])) {
            ...
            print(":: <img src=\"pic/buttons/button_".$online.".gif\" alt=\"".$online_text."\" title=\"".$online_text."\" style=\"position: relative; top: 2px;\" border=\"0\" height=\"14\">"
                ...
                ." :: <font color=\"".get_ratio_color($ratio)."\">$ratio</font> :: ";
        ...
        if ($row["editedby"]) {
            $text .= "<p><font size=1 class=small>Последнее редактирование: <a href=userdetails.php?id=$row[editedby]><b>$row[editedbyname]</b></a> в $row[editedat]</font></p>\n";
        }
        ...
        print("<div align=\"right\"><!--<font size=1 class=small>-->Дата добавления: ".$row["added"]." GMT<!--</font>--></div></td></tr>");
        print("</table><br>");
    }
}
?>
