...
function FaqAdmin() {
	...
	if (isset($faq_categ)) {
		...
		print("<tr><td class=\"colhead\" align=\"center\" colspan=\"2\">�������</td><td class=\"colhead\" align=\"left\">������/��������</td><td class=\"colhead\" align=\"center\">������</td><td class=\"colhead\" align=\"center\">��������</td></tr>\n");
		...
		$status = ($faq_categ[$id]["flag"] == "0") ? "<font color=\"red\">������</font>" : "�������";
		...
		if (array_key_exists("items", $faq_categ[$id])) {
			foreach ($faq_categ[$id]["items"] as $id2 => $temp) {
				...
				if ($faq_categ[$id]["items"][$id2][flag] == "0") $status = "<font color=\"#FF0000\">������</font>";
				...
				elseif ($faq_categ[$id]["items"][$id2][flag] == "3") $status = "<font color=\"#008000\"><img src=\"".$rootpath.$pic_base_url."/new.png\" alt=\"�����\" align=\"absbottom\"></font>";
				else $status = "�������";
		...
		print("<tr><td colspan=\"5\" align=\"center\"><a href=\"$admin_file.php?op=FaqAction&action=additem&inid=". $id ."\">�������� ����� �������</a></td></tr>\n");
		print("</table>\n");
		}
	}
	...
	if (isset($faq_orphaned)) {
		print("<br />\n<table border=\"1\" cellspacing=\"0\" cellpadding=\"5\" align=\"center\" width=\"95%\">\n");
		print("<tr><td align=\"center\" colspan=\"3\"><b style=\"color: #FF0000\">��������� ��������</b></td>\n");
		...
		foreach ($faq_orphaned as $id => $temp) {
			if ($faq_orphaned[$id]["flag"] == "0") $status = "<font color=\"#FF0000\">������</font>";
			elseif ($faq_orphaned[$id]["flag"] == "2") $status = "<font color=\"#0000FF\">���������</font>";
			elseif ($faq_orphaned[$id]["flag"] == "3") $status = "<font color=\"#008000\">�����</font>";
			else $status = "�������";
	...
	print("<br />\n<table border=\"1\" cellspacing=\"0\" cellpadding=\"5\" align=\"center\" width=\"95%\">\n<tr><td align=\"center\"><a href=\"$admin_file.php?op=FaqAction&action=addsection\">�������� ����� ������</a></td></tr>\n</table>\n");
	print("<p align=\"center\"><input type=\"submit\" name=\"reorder\" value=\"�����������\" class=\"btn\"></p>\n");
	print("</form>\n");
}
...
function FaqAction() {
	...
	if ($arr[type] == "item") {
		...
		print("<tr><td>������:</td><td><input id=specialboxg type=\"text\" name=\"question\" value=\"$arr[question]\" size=50 /></td></tr>\n");
		print("<tr><td style=\"vertical-align: top;\">�����:</td><td><textarea id=specialboxg rows=15 cols=80 name=\"answer\">$arr[answer]</textarea></td></tr>\n");
		print("<tr><td>������:</td><td><select name=\"flag\" style=\"width: 110px;\"><option value=\"0\" style=\"color: #FF0000;\"".($arr['flag'] == 0 ? " selected" : "").">������</option><option value=\"1\" style=\"color: #000000;\"".($arr['flag'] == 1 ? " selected" : "").">�������</option><option value=\"2\" style=\"color: #0000FF;\" ".($arr['flag'] == 2 ? "selected" : "").">���������</option><option value=\"3\" style=\"color: #008000;\" ".($arr['flag'] == 3 ? "selected" : "").">�����</option></select></td></tr>");
		...
		print("</td></tr>\n");
		print("<tr><td colspan=\"2\" align=\"center\"><input type=\"submit\" name=\"edit\" value=\"���������������\" class=\"btn\"></td></tr>\n");
		print("</table>");
	}
	elseif ($arr[type] == "categ") {
		...
		print("<tr><td>ID:</td><td>$arr[id] <input type=\"hidden\" name=\"id\" value=\"$arr[id]\" /></td></tr>\n");
		print("<tr><td>��������:</td><td><input style=\"width: 300px;\" type=\"text\" name=\"title\" value=\"$arr[question]\" id=specialboxn /></td></tr>\n");
		if ($arr[flag] == "0")
			print("<tr><td>������:</td><td><select name=\"flag\" style=\"width: 110px;\"><option value=\"0\" style=\"color: #FF0000;\">������</option><option value=\"1\" style=\"color: #000000;\">�������</option></select></td></tr>");
		else
			print("<tr><td>������:</td><td><select name=\"flag\" style=\"width: 110px;\"><option value=\"0\" style=\"color: #FF0000;\"".($arr['flag'] == 0 ? " selected" : "").">������</option><option value=\"1\" style=\"color: #000000;\"".($arr['flag'] == 1 ? " selected" : "").">�������</option></select></td></tr>");
		print("<tr><td colspan=\"2\" align=\"center\"><input type=\"submit\" class=btn name=\"edit\" value=\"���������������\"></td></tr>\n");
		print("</table>");
	}
	}
	...
	elseif ($_GET[action] == "additem" && $_GET["inid"]) {
		...
		print("<table border=\"1\" cellspacing=\"0\" cellpadding=\"5\" align=\"center\" width=\"100%\">\n");
		print("<tr><td>������:</td><td><input id=specialboxg type=\"text\" name=\"question\" value=\"\" /></td></tr>\n");
		print("<tr><td style=\"vertical-align: top;\">�����:</td><td><textarea id=specialboxg rows=15 cols=80 name=\"answer\"></textarea></td></tr>\n");
		print("<tr><td>������:</td><td><select name=\"flag\" style=\"width: 110px;\"><option value=\"0\" style=\"color: #FF0000;\">������</option><option value=\"1\" style=\"color: #000000;\">�������</option><option value=\"2\" style=\"color: #0000FF;\">���������</option><option value=\"3\" style=\"color: #008000;\">�����</option></select></td></tr>");
		print("<tr><td>���������:</td><td><select style=\"width: 300px;\" name=\"categ\" />");
	...
	elseif ($_GET[action] == "addsection") {
		...
		print("<tr><td>Status:</td><td><select name=\"flag\" style=\"width: 110px;\"><option value=\"0\" style=\"color: #FF0000;\">������</option><option value=\"1\" style=\"color: #000000;\">�������</option></select></td></tr>");
