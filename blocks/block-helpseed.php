...
if (mysqli_num_rows($res) > 0) {
	while ($arr = mysqli_fetch_assoc($res)) {
		...
		$content .= "<b><a href=\"details.php?id=".$arr['id']."&hit=1\" alt=\"".$arr['name']."\" title=\"".$arr['name']."\">".$torrname."</a></b><font color=\"#0099FF\"><b> (�������: ".number_format($arr['seeders'])." ������: ".number_format($arr['leechers']).")</b></font><br />\n";
	}
} else
