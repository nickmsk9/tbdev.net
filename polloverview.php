...
"<td class=colhead align=center>ID</td><td class=colhead>��������</td><td class=colhead>������</td></tr>\n");
...
if (mysqli_num_rows($sql) == 0) {
 print("<tr><td colspan=2>��������...��� ������ � ����� ID!</td></tr></table>");
 stdfoot();
 exit;
 }
...
print("<h1>����� �������</h1><br />\n");
print("<table width=750 border=1 cellspacing=0 cellpadding=5><tr><td class=colhead>����� �</td><td class=colhead>�����</td></tr>\n");
...
print("<p><table width=750 border=1 cellspacing=0 cellpadding=5><tr>\n" .
"<td class=colhead align=center>������������</td><td class=colhead>�����</td></tr>\n");
